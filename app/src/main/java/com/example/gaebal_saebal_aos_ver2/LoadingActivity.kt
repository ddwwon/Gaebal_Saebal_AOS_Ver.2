...
import com.example.gaebal_saebal_aos_ver2.databinding.ActivityLoadingBinding
...
class LoadingActivity : AppCompatActivity() {
    ...
    private fun splachAnimation() {
        val centerAnim: Animation = AnimationUtils.loadAnimation(this, R.anim.anim_splash_center)
